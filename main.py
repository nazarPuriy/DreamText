...
if __name__ == '__main__':
    ...
    ### training options
    parser.add_argument('--iters', type=int, default=10100, help="training iters")
    ...
    parser.add_argument('--option', type=int, default=0, help="Which execution option")
    parser.add_argument('--epoch', type=int, default=100, help="Which execution option")

    parser.add_argument('--ttype', type=str, default='None',  help="Type")
    parser.add_argument('--ttime', type=int, default=10000, help="Time")
    parser.add_argument('--g', type=int, default=100, help="Time")

    parser.add_argument('--token_path', type=str, default='None',  help="Type")
    parser.add_argument('--placeholder_token_id', type=str, default='None',  help="Type")
    parser.add_argument('--number_embed', type=int, default=2, help="Time")
    parser.add_argument('--load_token', type=int, default=0)
    ...
    if opt.test:
        ...
        if opt.guidance == 'stable-diffusion':
            ...
            guidance = StableDiffusion(device, opt.fp16, opt.vram_O, opt.sd_version, opt.hf_key, opt.option, opt=opt)
